...
const SignupModal = ({ onClose,setState }) => {
...
//   if(!visible) return null;   
  return (
    ...
    >
        <div className="bg-gradient-to-t bg-[#002b23] from-[#001e18] to-transparent w-[22rem] sm:w-[27rem] md:h-[40rem] border-2 rounded-xl">
            <div className="p-6 space-y-6 sm:space-y-[2rem]">
                ...
                <form>
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="">
                            <input id="Name" type="text" className=" h-10 sm:h-12 w-full rounded-lg bg-[#002b23] px-4 border-2 border-[#3D8361] outline-none text-[#3D8361] focus:ring-0 focus:ring-[#3D8361] placeholder-[#3D8361]" placeholder="Name"/>
                        </div>
                        <div className="">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-start">
                        ...
                        <div className="text-sm font-medium text-secondaryText hover:underline">
                            <p onClick={handleClick} >Signin</p>
                        </div>
                    </div>
